	...
	while($row = $query->fetch_assoc()){
		...
		while($crow = $cquery->fetch_assoc()){
			...
			$candidate .= '
				<li>
						'.$input.'
						<button class="btn btn-primary btn-sm clist"><i class="fa fa-search"></i> Platform</button>
						<img src="'.$image.'" height="100px" width="100px" class="clist img-fluid">
						...
						<div class="box-body">
							<p>'.$instruct.'
								<span class="pull-right">
									<button type="button" class="btn btn-success btn-sm reset" data-desc="'.slugify($row['description']).'"><i class="fa fa-refresh"></i> Reset</button>
								</span>
							</p>
